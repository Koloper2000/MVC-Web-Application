<%@ Page Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="VrstaTabelarni.aspx.cs" Inherits="KorisnickiInterfejs.VrstaTabelarni" %>
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td class="auto-style1" align="center" colspan="2">
                <asp:GridView ID="gvSpisakVrsteTreninga" runat="server" Height="211px" Width="920px" HorizontalAlign="Center" OnSelectedIndexChanged="gvSpisakVrsteTreninga_SelectedIndexChanged" >
